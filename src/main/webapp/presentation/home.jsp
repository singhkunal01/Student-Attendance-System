  ...
  <body>
    <div class="main-container">
      <div class="first-section">
        <li>
          This system is purely made for the
          <span> Future Institute of Engineering & Technology </span> for the
          Attendance & Leaves purpose
        </li>
        <li>Here Student Can apply For Attendance and Leaves.</li>
        <li>
          And Respective Faculty Can approve or reject attendance or leave.
        </li>
      </div>
      ...
      <div class="second-section">
        ...
        <%--<img
          src="${pageContext.request.contextPath}/presentation/images/college-img.jpg"
          alt="college-photo"
        />
        --%>
