...
<body>
  ...
  <% java.util.ArrayList studentDetails=new java.util.ArrayList(); studentDetails=(java.util.ArrayList)
    request.getAttribute("listOfAllStudents");%>
    <header>
    </header>
    <div class="main-container">
      <div class="first-section">
        <p class="icon"> <i class="fa-sharp fa-light fa-user"></i> ${currentUser} </p>
        <p class="icon fa-fade"> <i class="fa-sharp fa-arrow-right-from-bracket fa-beat"></i><a href="logout">
            Logout </a></p>
            ...
            <tbody>
              <c:forEach items="${listOfAllStudents}" var="value">
                ...
                <tr>
                  ...
                  <td><i class="fa-solid fa-arrow-right fa-beat-fade"></i><a
                      href="faculty/studentDetail?username=${value.getStudentUsername()}">
                      ${value.getRollNumber()}</a></td>
                </tr>
              </c:forEach>
