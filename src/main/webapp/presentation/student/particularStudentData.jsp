...
studentDetails = (java.util.ArrayList) request.getAttribute("currentStudentWholeRecord");%>
...
<c:forEach items="${currentStudentWholeRecord}" var="value">
        ...
        <tr>
            ...
            <a class = "fa-fade approval" href = "studentDetail/approve?rollNumber=${value.getRollNumber()}&dateOfAttendance=${value.getAttendanceDate()}"> Approve</a>
            <a class = "fa-fade rejection" href = "studentDetail/reject?rollNumber=${value.getRollNumber()}&dateOfAttendance=${value.getAttendanceDate()}"> Reject</a>
            </td>
        </tr>
</c:forEach>
