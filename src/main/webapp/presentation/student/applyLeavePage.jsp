...
<div class="main-container">
    <div class="first-section">
        <p class="icon"> <i class="fa-sharp fa-light fa-user"></i> Hi,
            &nbsp;${currentLoggedInStudentData.getStudentName()} </p>
        <p class="icon fa-fade"> <i class="fa-sharp fa-arrow-right-from-bracket fa-beat"></i><a
                href="${pageContext.request.contextPath}/loginPage"> Back </a></p>
        <p style="color:#e0d684;"> <i class="fa-sharp fa-calendar-days"></i>
            ${currentSystemDate}</p>
    </div>
    ...
    <div class="second-section">
        ...
        <div class="studentData">
            <ul>
                <li><strong>Roll Number :</strong>${currentLoggedInStudentData.getRollNumber()}
                </li>
                ...
                <li><strong>Current Year
                        :</strong>${currentLoggedInStudentData.getCurrentYear()}</li>
                <li><strong>Date Of Birth
                        :</strong>${currentLoggedInStudentData.getDateOfBirth()}</li>
            </ul>
        </div>
        <div class="formDetails">
            <div>
                <form:form modelAttribute="studentAttendanceRecord" method="POST">
                    ...
                    <div id="leaveReasonContainer">
                        <label> Reason For Taking Leave : </label>
                        <form:textarea path="reason" rows="3" cols="40" required="required" />
                        <br>
